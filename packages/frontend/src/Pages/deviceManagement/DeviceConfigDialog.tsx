...
function convertJsonToYamlHtml(data: JSONValue, prefix = "", uniqKey = "device"): JSX.Element {
    ...
    if (Array.isArray(data)) {
        ...
        Object.entries(data).forEach(([key, value]) => {
            ...
            items.push(<Typography component="span" key={`${reactKey}`}>{first ? prefix : toSpaces(prefix)}{key}:  </Typography>)
        ...
        items.push(<Typography component="span" key={uniqKey + "v"}>{prefix}{data.toString()}</Typography>)
