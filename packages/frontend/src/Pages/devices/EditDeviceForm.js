		...
		<Fragment>
			<Card className={classes.card}>
				...
				<CardContent className={classes.content}>
					<div className={classes.contentInner}>
						...
						<ImageUploader defaultImage={device.info.imgPath} deepPath="EDIT_DEVICE.info.image" />
						<div>
							<FieldConnector deepPath="EDIT_DEVICE.info.title" />
							<FieldConnector label="Zeměpisná šířka" deepPath="EDIT_DEVICE.gps.coordinates.1" />
							<FieldConnector label="Zeměpisná délka" deepPath="EDIT_DEVICE.gps.coordinates.0" />
						</div>
					</div>
					<FieldConnector
						fieldProps={{
					...
					<div className={classes.topicWrapper}>
						<TextField
							...
							helperText={
								topicRegisteredField && topicRegisteredField.errorMessages ? (
									topicRegisteredField.errorMessages[0]
								) : (
									''
								)
							}
			...
			<Dialog
				...
				content={
					<Fragment>
						<DialogContentText>
							Pokud upravíte topic, tak je třeba pře-flashovat zařízení, aby si stáhl aktuální topic do
							paměti jinak přestane fungovat.
						</DialogContentText>
						<FieldConnector
...
export default connect(_mapStateToProps, _mapDispatchToProps)(withStyles(styles)(EditDeviceDialog));
