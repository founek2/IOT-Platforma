...
function Sensors({ fetchDevicesAction, updateDeviceAction, devices, classes, updateSensorsAction, openNotifyDialog, selectedDevice, resetEditNotifySensorsA, history, isUserPresent, updateNotifySensorsAction, prefillNotifySensorsAction, simpleDevice }) {
    useEffect(() => {
        fetchDevicesAction()
