...
module.exports = function(app) {
 console.log("setting proxy")
  ...
  // app.use(proxy('/socket.io', { target: 'https://test.iotplatforma.cloud', ws: true, secure: false, changeOrigin: true }));
  // app.use(proxy('/images', { target: 'https://test.iotplatforma.cloud', secure: false, changeOrigin: true }));
};
