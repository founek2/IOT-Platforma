...
type RequestIndex = RequestWithAuth<{}, { type?: string }> & HasContext;
type RequestRead = RequestWithAuth<{ id: string }, { attribute?: string }> & HasContext;
type RequestId = RequestWithAuth<{ id: string }> & HasContext;
